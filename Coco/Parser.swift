...
public class Parser {
    ...
    func Get () {
        for ;; {
            ...
            if la.kind == 42 /* ddtSym */ {
                tab.SetDDT(la.val)
            }
            if la.kind == 43 /* optionSym */ {
    ...
    func Coco() {
        ...
        if la.kind == 8 /* "CHARACTERS" */ {
            Get()
            while la.kind == 1 /* ident */ {
                SetDecl()
            }
        }
        if la.kind == 9 /* "TOKENS" */ {
            Get()
            while la.kind == 1 /* ident */ || la.kind == 3 /* string */ || la.kind == 5 /* char */ {
                TokenDecl(Node.t)
            }
        }
        ...
        while !(la.kind == 0 /* EOF */ || la.kind == 16 /* "PRODUCTIONS" */) { SynErr(42); Get() }
    ...
    func Sym(inout name: String, inout _ kind: Int) {
        ...
        if la.kind == 1 /* ident */ {
            Get()
            kind = id; name = t.val
        } else if la.kind == 3 /* string */ || la.kind == 5 /* char */ {
            if la.kind == 3 /* string */ {
                Get()
                name = t.val
            } else {
    ...
    func Factor(inout g: Graph?) {
        ...
        switch la.kind {
        case 1 /* ident */, 3 /* string */, 5 /* char */, 29 /* "WEAK" */:
            if la.kind == 29 /* "WEAK" */ {
                Get()
                weak = true
            }
    ...
    func TokenFactor(inout g: Graph?) {
        var name = ""; var kind = 0
        g = nil
        if la.kind == 1 /* ident */ || la.kind == 3 /* string */ || la.kind == 5 /* char */ {
            Sym(&name, &kind)
            if kind == id {
